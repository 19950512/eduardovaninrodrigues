...
import { artigo as traficoPrivilegiadoOQueEEQuandoPodeSerAplicado } from "./trafico-privilegiado-o-que-e-e-quando-pode-ser-aplicado";
...
const registro: Artigo[] = [
  ...
  traficoPrivilegiadoOQueEEQuandoPodeSerAplicado,
