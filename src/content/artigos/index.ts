...
import { artigo as traficoPrivilegiadoOQueEEQuaisOsRequisitosParaSeuReconhecimento } from "./trafico-privilegiado-o-que-e-e-quais-os-requisitos-para-seu-reconhecimento";
...
const registro: Artigo[] = [
  ...
  traficoPrivilegiadoOQueEEQuaisOsRequisitosParaSeuReconhecimento,
