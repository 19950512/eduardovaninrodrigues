...
import { artigo as traficoPrivilegiadoQuandoAReducaoDePenaEAplicavelNoCrimeDeDrogas } from "./trafico-privilegiado-quando-a-reducao-de-pena-e-aplicavel-no-crime-de-drogas";
...
const registro: Artigo[] = [
  ...
  traficoPrivilegiadoQuandoAReducaoDePenaEAplicavelNoCrimeDeDrogas,
