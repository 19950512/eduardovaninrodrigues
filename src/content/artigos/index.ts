...
import { artigo as buscaEApreensaoDomiciliarQuaisSaoOsRequisitosLegais } from "./busca-e-apreensao-domiciliar-quais-sao-os-requisitos-legais";
...
const registro: Artigo[] = [
  ...
  buscaEApreensaoDomiciliarQuaisSaoOsRequisitosLegais,
