...
import { artigo as traficoPrivilegiadoOQueEEQuandoPodeSerAfastado } from "./trafico-privilegiado-o-que-e-e-quando-pode-ser-afastado";
...
const registro: Artigo[] = [
  ...
  traficoPrivilegiadoOQueEEQuandoPodeSerAfastado,
